...
int bee_schema_add_spaces(struct bee_schema *schema_obj,
				const char *data,
				uint32_t size) {
...
int bee_schema_add_indexes(struct bee_schema *schema_obj,
				 const char *data,
				 uint32_t size) {
	struct mh_schema_space_t *schema = schema_obj->space_hash;
	const char *tuple = data;
...
int32_t bee_schema_get_sid_by_string(struct bee_schema *schema_obj,
...
int32_t bee_schema_get_iid_by_string(struct bee_schema *schema_obj,
...
struct bee_schema *bee_schema_new(int is_persistent) {
	struct bee_schema *obj = pemalloc(sizeof(struct bee_schema *), 1);
	obj->space_hash = mh_schema_space_new();
	return obj;
}

void bee_schema_flush(struct bee_schema *obj) {
	schema_space_free(obj->space_hash);
}

void bee_schema_delete(struct bee_schema *obj, int is_persistent) {
	if (obj == NULL) return;
	schema_space_free(obj->space_hash);
